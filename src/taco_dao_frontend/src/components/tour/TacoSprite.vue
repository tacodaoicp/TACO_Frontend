<template>
  <div class="tour-sprite tour-sprite--taco"
       :class="[
    ...
    <div class="tour-sprite__body">
      ...
      <!-- main image — swap this src for custom artwork -->
      <img :src="tacoDaoTacoSimpleImage"
           class="tour-sprite__img"
           alt="TACO" />

      <!-- placeholder face overlay (rendered using selected face style) -->
...
.tour-sprite {
  ...
  // enter animation
  &--enter {
    animation: sprite-enter-left 0.5s ease-out forwards;
  }
  &--exit {
    animation: sprite-exit-left 0.4s ease-in forwards;
  }
  ...
  // slap screen
  &--slap-screen &__body {
    animation: sprite-slap 0.3s ease-in forwards;
  }
...
@keyframes sprite-slap {
  0% { transform: scale(1) translateZ(0); }
  50% { transform: scale(1.3) translateZ(0); }
  100% { transform: scale(1.5) translateZ(0); opacity: 0.8; }
}
